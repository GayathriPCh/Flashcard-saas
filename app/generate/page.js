    ...
    return (
        ...
        >
            ...
            <Box sx={{ display: 'flex', justifyContent: 'flex-start', alignItems: 'flex-start', mb: 2 }}>
                <Button href="/" sx={{ color: '#4fffff', display: 'flex', alignItems: 'center' }}>
            ...
            <Container maxWidth="md">
                <Box sx={{ mb: 6, textAlign: 'center' }}>
                    <Typography variant="h4" sx={{ paddingTop: 4, fontFamily: 'Panforte',color: 'white', fontWeight: 'bold' }} gutterBottom>
                        Flashcards
                    </Typography>
                ...
                >
                    <Tabs value={selectedTab} onChange={handleTabChange} centered>
                        <Tab label="Generated cards" sx={{fontFamily:'Panforte', minWidth: 'unset', color: selectedTab === 0 ? '#4fffff' : 'white', fontWeight: selectedTab === 0 ? 'bold' : 'normal' }} />
                        <Tab label="My collections" sx={{fontFamily:'Panforte', minWidth: 'unset', color: selectedTab === 1 ? '#4fffff' : 'white', fontWeight: selectedTab === 1 ? 'bold' : 'normal' }} />
                    </Tabs>
                    ...
                    {selectedTab === 0 && (
                        <Box sx={{ p: 3 }}>
                            {flashcards.length > 0 ? (
                                                ...
                                                >
                                                    ...
                                                    <IconButton
                                                        sx={{
                                                            ...
                                                            top: 8,
                                                            right: 8,
                                                            color: savedCards.includes(flashcard) ? '#4fffff' : '#757575',
                                                        }}
                                ...
                                <Typography variant="body1" sx={{ textAlign: 'center', color: 'white',fontFamily:'Panforte' }}>Enter your topics of interest and hit generate!</Typography>
                            )}
                        </Box>
                    )}
                    ...
                    {selectedTab === 1 && (
                        <Box sx={{ p: 3 }}>
                            {savedCards.length > 0 ? (
                                    ...
                                    {savedCards.map((flashcard, index) => (
                                        <Grid item xs={12} sm={6} md={4} key={index}>
                                            ...
                                            >
                                                ...
                                                >
                                                    <CardContent sx={{ position: 'absolute', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', backfaceVisibility: 'hidden' }}>
                                                        <Typography variant="h6" sx={{ textAlign: 'center', padding: 2, color: '#000',fontFamily:'Panforte' }}>
                                                            {flashcard.front}
                                                        </Typography>
                                                    </CardContent>
                                                    <CardContent sx={{ position: 'absolute', width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', transform: 'rotateY(180deg)', backfaceVisibility: 'hidden' }}>
                                ...
                                <Typography variant="body1" sx={{ textAlign: 'center', color: 'white',fontFamily:'Panforte' }}>No saved cards available.</Typography>
                            )}
                        </Box>
                    )}
                </Box>
            ...
            <Dialog open={open} onClose={handleClose}>
                <DialogTitle sx={{ color: '#4fffff', fontFamily: 'Panforte', }}>Save Flashcards</DialogTitle>
                <DialogContent>
                    <DialogContentText sx={{ color: 'grey.700', fontFamily: 'Panforte', }}>
