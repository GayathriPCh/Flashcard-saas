...
const systemPrompt = `
You are a flashcard creator, you take in text and create multiple flashcards from it. Make sure to create 10, or if user specifies, then those many set of flashcards.
Both front and back should be one sentence long.And please sensible important questions please.
